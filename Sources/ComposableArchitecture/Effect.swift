...
@available(
  ...
  message:
    ...
    'EffectPublisher' has been deprecated in favor of 'Effect'.
     ...
     You are encouraged to use `Effect<Action>` to model the ouput of your reducers, and to use Swift concurrency to model asynchrony in dependencies.
...
///
/// > Important: The publisher interface to ``Effect`` is considered deperecated, and you should
